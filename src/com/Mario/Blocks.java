...
/**
 * Renders each block based on a type
 *
 * @Daniel Bauer
 * @5/25/18
 */
...
public class Blocks
{
    ...
    public void render(int x, Graphics g)
    {
        ...
        Color brown = new Color(130, 76, 40);
        ...
        else if(type.equals("PIPE_TOP_L")){
            g2.setColor(Color.GREEN);
            g2.fillRect(x + 2, y + 2, 48, 46);
        }
        else if(type.equals("PIPE_TOP_R")){
            g2.setColor(Color.GREEN);
            g2.fillRect(x, y + 2, 48, 46);
        }
        else if(type.equals("PIPE_L")){
            g2.setColor(Color.BLACK);
            g2.fillRect(x + 8, y, 42, 50);
            g2.setColor(Color.GREEN);
            g2.fillRect(x + 10, y, 40, 50);
        }
        else if(type.equals("PIPE_R")){
            g2.setColor(Color.BLACK);
